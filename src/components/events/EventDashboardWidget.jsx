...
const {FiCalendar,FiClock,FiMapPin,FiMic,FiPackage,FiUsers,FiChevronRight,FiInfo}=FiIcons;
...
return (
<div className="bg-white rounded-lg shadow-sm border overflow-hidden h-[400px] flex flex-col">
...
{event.participationType===PARTICIPATION_TYPES.EXHIBITOR ? 'Exhibitor' : 
event.participationType===PARTICIPATION_TYPES.SPEAKER ? 'Speaker' : 'Exhibitor & Speaker'}
</span>
</div>
...
event.participationType===PARTICIPATION_TYPES.EXHIBITOR ? 'text-blue-600 bg-blue-100' : 
event.participationType===PARTICIPATION_TYPES.SPEAKER ? 'text-green-600 bg-green-100' : 
'text-purple-600 bg-purple-100'
}`}>
{event.participationType===PARTICIPATION_TYPES.EXHIBITOR ? 'Exhibitor' : 
event.participationType===PARTICIPATION_TYPES.SPEAKER ? 'Speaker' : 'Both'}
</span>
</div>
</div>
</div>
